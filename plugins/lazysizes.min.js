  ...
  var f = b.documentElement, g = a.HTMLPictureElement, h = "addEventListener", i = "getAttribute", j = a[h].bind(a),
    ...
    o = ["load", "error", "lazyincluded", "_lazyloaded"], p = {}, q = Array.prototype.forEach, r = function (a, b) {
      ...
      var g, m, o, p, y, D, F, G, H, I, J, K, L = /^img$/i, M = /^iframe$/i,
        N = "onscroll" in a && !/(gle|ing)bot/.test(navigator.userAgent), O = 0, P = 0, Q = 0, R = -1, S = function (a) {
...
!function (a, b) {
  ...
  function d(a, c) {
    if (!h[a]) {
      ...
      c ? (d.rel = "stylesheet", d.href = a) : d.src = a, h[a] = !0, h[d.src || d.href] = !0, e.parentNode.insertBefore(d, e)
    }
  }

  var f, g, h = {};
  b.addEventListener && (g = /\(|\)|\s|'/, f = function (a, c) {
    ...
    if (a.detail.instance == c) {
      ...
      if (!a.defaultPrevented) {
        ...
        b = j.getAttribute("data-link"), b && "img" != j.tagName.toLowerCase() && d(b, !0), b = j.getAttribute("data-script"), b && d(b), b = j.getAttribute("data-require"), b && (c.cfg.requireJs ? c.cfg.requireJs([b]) : d(b)), h = j.getAttribute("data-bg"), h && (a.detail.firesLoad = !0, e = function () {
          j.style.backgroundImage = "url(" + (g.test(h) ? JSON.stringify(h) : h) + ")", a.detail.firesLoad = !1, c.fire(j, "_lazyloaded", {}, !0, !0)
        }, f(h, e)), i = j.getAttribute("data-poster"), i && (a.detail.firesLoad = !0, e = function () {
